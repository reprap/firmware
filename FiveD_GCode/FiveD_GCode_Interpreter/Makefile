...
#
# Further modified by Jonathan Marsden <jmarsden@fastmail.fm> to
#   concatenate multiple .pde files together as the IDE does
#
...
ARDUINO = $(INSTALL_DIR)/hardware/$(CORE)/cores/arduino
